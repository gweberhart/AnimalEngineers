...
public class FAQPagePresenter implements Presenter {
  ...
  public FAQPagePresenter(AEServicesAsync rpcService, SimpleEventBus eventBus,
  ...
  public void go(HasWidgets container) {
    ...
    eventBus.fireEvent(new ViewChangeEvent(ViewENUM.FAQ));
  }
}
