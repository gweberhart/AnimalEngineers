package org.ae.client.view.mission;
...
public class MissionPageView extends Composite implements
    MissionPagePresenter.Display {
  private LayoutContainer pnlStatenentAndAdds;

  public MissionPageView() {
    ...
    pnlStatement
        .setHeading("Welcome to " + Rescue.getCurrentRescue().getName());
    pnlStatement.setUrl(ClientUtils.getImagePath() + "mission.html");
    if (ClientUtils.isGreyhounds()) {
      pnlStatement.setHeight(830);
    } else {
