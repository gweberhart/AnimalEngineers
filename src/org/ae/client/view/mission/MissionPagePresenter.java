...
public class MissionPagePresenter implements Presenter {
  ...
  public MissionPagePresenter(AEServicesAsync rpcService,
  ...
  public void go(HasWidgets container) {
    ...
    eventBus.fireEvent(new ViewChangeEvent(ViewENUM.MISSION));
  }
}
