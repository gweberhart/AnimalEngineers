 ...
 * 
 *         <p>
 *         When the user selects a file, the button changes its style so the she
 *         could realize that she has to push the button.
 *         </p>
 * 
 */
public class SingleUploader extends Uploader {
  ...
  /**
   * Default constructor. Uses the standard browser input, a basic status
   * widget, and creates a standard button to send the file
   * 
   */
   ...
   */
  public SingleUploader(FileInputType type, IUploadStatus status,
      Widget submitButton, FormPanel form) {
    super(type, form);
  ...
  /**
   * Uses the standard browser input, customized status, and creates a standard
   ...
   * (non-Javadoc)
   * 
   * @see gwtupload.client.Uploader#setI18Constants(gwtupload.client.IUploader.
   * UploaderConstants)
   */
  @Override
