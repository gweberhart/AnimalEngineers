...
public class MissionPageAction extends UIAction {

  public MissionPageAction(AEServicesAsync rpcService, SimpleEventBus eventBus,
  ...
  public void go(HasWidgets container, NavigateEvent event) {
    History.newItem(ViewENUM.MISSION.getHistoryToken(), false);
    presenterFactory.getPresenter(Presenters.MISSION_PAGE).go(container);
  }
